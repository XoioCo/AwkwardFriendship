...
function dart_precompiled($collectedClasses) {
  ...
  function start_closure1(user_0) {
    this.user_0 = user_0;
  }
  ...
  function sendMessage_closure(t_0) {
    this.t_0 = t_0;
  }
  sendMessage_closure.builtin$cls = "sendMessage_closure";
  if (!"name" in sendMessage_closure)
    sendMessage_closure.name = "sendMessage_closure";
  $desc = $collectedClasses.sendMessage_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  sendMessage_closure.prototype = $desc;
  function sendMessage__closure() {
  }
  sendMessage__closure.builtin$cls = "sendMessage__closure";
  if (!"name" in sendMessage__closure)
    sendMessage__closure.name = "sendMessage__closure";
  $desc = $collectedClasses.sendMessage__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  sendMessage__closure.prototype = $desc;
  function sendMessage___closure() {
  }
  sendMessage___closure.builtin$cls = "sendMessage___closure";
  if (!"name" in sendMessage___closure)
    sendMessage___closure.name = "sendMessage___closure";
  $desc = $collectedClasses.sendMessage___closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  sendMessage___closure.prototype = $desc;
  function Tweet(msg, sender, recipient, rnd) {
    this.msg = msg;
    this.sender = sender;
    this.recipient = recipient;
    this.rnd = rnd;
  }
  Tweet.builtin$cls = "Tweet";
  if (!"name" in Tweet)
    Tweet.name = "Tweet";
  $desc = $collectedClasses.Tweet;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Tweet.prototype = $desc;
  function Tweet_sendMessage_closure(callback_0) {
    this.callback_0 = callback_0;
  }
  Tweet_sendMessage_closure.builtin$cls = "Tweet_sendMessage_closure";
  if (!"name" in Tweet_sendMessage_closure)
    Tweet_sendMessage_closure.name = "Tweet_sendMessage_closure";
  $desc = $collectedClasses.Tweet_sendMessage_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Tweet_sendMessage_closure.prototype = $desc;
  function Flickr(url, image, rnd) {
    this.url = url;
    this.image = image;
    this.rnd = rnd;
  }
  Flickr.builtin$cls = "Flickr";
  if (!"name" in Flickr)
    Flickr.name = "Flickr";
  $desc = $collectedClasses.Flickr;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Flickr.prototype = $desc;
  function Flickr_closure() {
  }
  Flickr_closure.builtin$cls = "Flickr_closure";
  if (!"name" in Flickr_closure)
    Flickr_closure.name = "Flickr_closure";
  $desc = $collectedClasses.Flickr_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Flickr_closure.prototype = $desc;
  function Flickr_getImage_closure(this_0) {
    this.this_0 = this_0;
  }
  Flickr_getImage_closure.builtin$cls = "Flickr_getImage_closure";
  if (!"name" in Flickr_getImage_closure)
    Flickr_getImage_closure.name = "Flickr_getImage_closure";
  $desc = $collectedClasses.Flickr_getImage_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Flickr_getImage_closure.prototype = $desc;
  function Request_post_closure(callback_0) {
    this.callback_0 = callback_0;
  }
  Request_post_closure.builtin$cls = "Request_post_closure";
  if (!"name" in Request_post_closure)
    Request_post_closure.name = "Request_post_closure";
  $desc = $collectedClasses.Request_post_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Request_post_closure.prototype = $desc;
  function Request_get_closure(url_0, callback_1) {
    this.url_0 = url_0;
    this.callback_1 = callback_1;
  }
  Request_get_closure.builtin$cls = "Request_get_closure";
  if (!"name" in Request_get_closure)
    Request_get_closure.name = "Request_get_closure";
  $desc = $collectedClasses.Request_get_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Request_get_closure.prototype = $desc;
  function Template(template, name, engine, appendedTo) {
    this.template = template;
    this.name = name;
    this.engine = engine;
    this.appendedTo = appendedTo;
  }
  Template.builtin$cls = "Template";
  if (!"name" in Template)
    Template.name = "Template";
  $desc = $collectedClasses.Template;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Template.prototype = $desc;
  function Template_loadTemplate_closure(this_0) {
    this.this_0 = this_0;
  }
  Template_loadTemplate_closure.builtin$cls = "Template_loadTemplate_closure";
  if (!"name" in Template_loadTemplate_closure)
    Template_loadTemplate_closure.name = "Template_loadTemplate_closure";
  $desc = $collectedClasses.Template_loadTemplate_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Template_loadTemplate_closure.prototype = $desc;
